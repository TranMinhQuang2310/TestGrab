...
public class MobileUI {
    ...
    public void scrollLeft() {
        sleep(STEP_ACTION_TIMEOUT);
        System.out.println("[MobileUI] Executing scrollLeft.");
    ...
    public void scrollRight() {
        sleep(STEP_ACTION_TIMEOUT);
        System.out.println("[MobileUI] Executing scrollRight.");
        Dimension size = DriverManager.getDriver().manage().window().getSize();
    ...
    public void tapToaDoTime(int x, int y, int second) {
        sleep(STEP_ACTION_TIMEOUT);
        System.out.println("[MobileUI] Executing tap at coordinates (" + x + "," + y + ") with pause " + second + "ms.");
        PointerInput finger = new PointerInput(PointerInput.Kind.TOUCH, "finger");
        Sequence tap = new Sequence(finger, 1);
        tap.addAction(finger.createPointerMove(Duration.ZERO, PointerInput.Origin.viewport(), x, y));
        tap.addAction(finger.createPointerDown(PointerInput.MouseButton.LEFT.asArg()));
