...
public class MobileUI_Using_LogUtils_AllureReport {
    ...
    @Step("Wait for element {0} to be clickable within {1}s")
    ...
    @Step("Wait for element {0} to be visible within {1}s")
    ...
    @Step("Wait for element {0} to be visible")
    ...
    @Step("Wait for element {0} to be invisible within {1}s")
    ...
    @Step("Wait for element {0} to be invisible")
    ...
    @Step("Wait for element {0} to be present within {1}s")
    ...
    @Step("Wait for text '{1}' to be present in element {0} within {2}s")
    ...
    @Step("Wait for text '{1}' to be present in element {0}")
    ...
    @Step("Wait for attribute '{1}' of element {0} to be '{2}' within {3}s")
    ...
    @Step("Wait for attribute '{1}' of element {0} to be '{2}'")
    ...
    @Step("Wait for number of elements located by {0} to be {1} within {2}s")
    ...
    @Step("Wait for number of elements located by {0} to be {1}")
    ...
    @Step("Wait for URL to contain '{0}' within {1}s")
    ...
    @Step("Wait for number of windows to be {0} within {1}s")
    ...
    @Step("Wait for number of windows to be {0}")
    ...
    @Step("Set text {1} into element {0} within {2}s")
    ...
    @Step("Get Attribute {1} from element {0} within {2}s")
    ...
    @Step("Check if element {0} is present and displayed")
    ...
    @Step("Verify element {0} is present and displayed - message is : {1}")
    ...
    @Step("Verify element {0} is enabled - message is : {1}")
    ...
    @Step("Verify element {0} is selected - message is : {1}")
    ...
    @Step("Verify element {0} has text '{1}' - message is : {2}")
    ...
    @Step("Verify element {0} has attribute '{1}' = '{2}' - message is : {3}")
    ...
    @Step("Assert condition is TRUE - message is : {1}")
