package com.quangtester.constants;
...
//Khai báo ra những biến chung tương ứng với các key trong properties file (oonfig.properties)
public class ConfigData {
    ...
    //final => nghĩa là cố định , khng cho phép thay đổi giá trị
    ...
    //Lấy giá trị json từ biến đã khai báo : JSON_CONFIG_FILE_PATH
